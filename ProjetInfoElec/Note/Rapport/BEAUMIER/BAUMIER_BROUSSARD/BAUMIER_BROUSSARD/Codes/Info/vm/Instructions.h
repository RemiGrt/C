...
* 			6 février 2017
* \brief 
* 			Regroupe toutes les instructions utiles pour l'exécution du compilateur
* 			 
*/
...
#define I_SUB			2		
/*! Effectue une division entre deux valeurs situées au sommet de la pile et garde l'entier supérieur*/
#define I_DIV			3		
