...
void initPattes(void)
{
   ...
   GPIOA->MODER &=~((1<<0)|(1<<1)|(1<<2)|(1<<3)|(1<<11)); // choix mode General Purpose input pour PA0 et PA1  et output pour PA5
   GPIOA->MODER |=(1<<10);   // choix mode General Purpose Output bitS pairs à '0' et bits impairs à 1
