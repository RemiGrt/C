      ...
      while (ern!=NULL)
        {
          ...
          // correspond au nom
           ...
           etape=finEtapeByName(en, ern->name);  //ToDO : appel de findEtapeByName, retour stocké dans etape
...
etape=en;
printf("#\ttest de franchissement de la transition t0\n");
while (etape!=NULL)
     {  printf("\tpush\t16\n");
        printf("\tpushi\t1\n");
        printf("\teq\n");
...
etape=en;
printf("#\ttest de franchissement de la transition t1\n");
while (etape!=NULL)
     {printf("\tpush\t17\n");
        printf("\tpushi\t1\n");
        printf("\teq\n");
...
etape=en;
printf("#\ttest de franchissement de la transition t2\n");
while (etape!=NULL)
     {printf("\tpush\t18\n");
        printf("\tpushi\t1\n");
        printf("\teq\n");
...
etape=en;
printf("#\ttest de franchissement de la transition t3\n");
while (etape!=NULL)
     {printf("\tpush\t19\n");
        printf("\tpushi\t1\n");
        printf("\teq\n");
